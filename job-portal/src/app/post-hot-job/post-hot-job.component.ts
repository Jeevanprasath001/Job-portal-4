...
export class PostHotJobComponent implements OnInit {
  ...
  // Dropdown options
  locations: string[] = ['Remote', 'New York', 'San Francisco', 'London', 'Berlin', 'Singapore', 'Tokyo', 'Sydney'];
  ...
  salaryRanges: string[] = ['$30k-$50k', '$50k-$80k', '$80k-$120k', '$120k-$150k', '$150k+'];
  ...
  jobs = [
    ...
    },
    {
      ...
      description: 'We are seeking a talented UI/UX Designer to create amazing user experiences. You will collaborate with product managers and developers to design intuitive interfaces for our products.',
